...
- Update the source inventory to `12 masters`, `49 active instances`, `939 total glyphs`, and `901 exporting glyphs`.
- List active OpenType features: `aalt`, `ccmp`, `locl`, `numr`, `dnom`, `frac`, `ordn`, `pnum`, `tnum`, `c2sc`, `smcp`, `case`, `dlig`, `liga`, `ss01`, `ss02`, `ss03`, and `ss04`.
...
- Keep `SS04` as the technical `I/J` forms showcase.
