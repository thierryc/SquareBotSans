...
def page_shell(number: int, title: str, content: str, classes: str = "") -> str:
    ...
    return current_templates().render(
        "page.html",
        {
            ...
            "footer_center": footer.get("center", metadata.get("version", "v2.008")),
...
def cover_content() -> str:
    ...
    wordmark = cover.get("wordmark", "ROBOT")
    if wordmark != "ROBOT":
        wordmark_html = e(wordmark)
    else:
        wordmark_html = """
          <span class="wordmark-R0" style='font-variation-settings:"wdth" 100, "wght" 900, "ital" 0'>R</span>
          <span class="wordmark-O1" style='font-variation-settings:"wdth" 100, "wght" 360, "ital" 0'>O</span>
...
def technical_specs_content() -> str:
    ...
    return current_templates().render(
        ...
        {
            "technical_title": f"{metadata.get('family', 'Square Bot Sans')} {metadata.get('version', 'v2.008')}",
...
def build_pages(data: dict | None = None, templates: TemplateStore | None = None) -> list[str]:
    ...
    pages.append(
        page_shell(
            ...
            + stat_card("Version", current_metadata().get("version", "v2.008").lstrip("v"), "UPM 1000")
        ...
        page_shell(
            ...
            <div class="final-grid">
              <div class="final-title">
                ...
                <h2>{e(current_metadata().get("family", "Square Bot Sans"))} {e(current_metadata().get("version", "v2.008"))}</h2>
              </div>
